    ...
    <tr>
      ...
      <td><?php echo $myData['nama_kabkot']; ?></td>
        ...
        <tr>
            ...
            <td><strong>:</strong></td>
            <td><strong><font color="red"><?php echo $myData['status_bayar']; ?></font><sup>*</sup></strong></td>
        </tr>
...
<table class="table table-bordered" border="1">
    <thead>
        <tr>
          <td colspan="3" bgcolor="#CCCCCC"><strong>Nro. Cuenta <font color="red" align="center"><b>Wollvi</b></font> <font color="green"><b>Tienda online<b></font></strong></td>
        </tr>
    </thead>
    <tbody>
      <tr>
            <td colspan="2" width="20%"><img src="images/BCP.png"></td>
            <td><p><strong>  
            Banco          : BCP<br />
            N Cuenta       : 005 021 01245<br />
            Beneficiario   : Victor Jose Carreño Guerra</strong></p></td>
      </tr>
      <tr>
           <td colspan="2" width="20%"><img src="images/bn.png"></td>
           <td><p><strong>  
            Banco          : Banco de la Nacion<br />
            N Cuenta       : 004 785 78452<br />
            Beneficiario   : Victor Jose Carreño Guerra</strong></p></td>
      </tr>
    </tbody>
</table>
