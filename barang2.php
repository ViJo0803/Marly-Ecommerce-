...
?>
	<div class="row">	  
		...
		<div class="span3 alignR">
			...
			<br/>
			  <a href="?open=Barang-Beli&Kode=<?php echo $KodeBarang; ?>&stok=<?php echo $stok; ?>" class="btn btn-link"><i class=" icon-shopping-cart"></i> Agregar a Carrito</a>
			  <a href="?open=Barang-Lihat&Kode=<?php echo $KodeBarang; ?>" class="btn btn-link">VER</a>
			</form>
		</div>
	</div>
	<!--<li class="span3">
