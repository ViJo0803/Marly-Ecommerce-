...
<html lang="en">
  <head>
    <meta charset="utf-8">
    <title>Tienda Online - Wollvi</title>
  ...
  <div class="span9">
   ...
   <div class="span9">
        ...
        <table class="table table-bordered" border="1">
            <thead>
                <tr>
                    <th colspan="5" bgcolor="#FF9933"><strong>Bancos donde puede realizar sus pagos</strong></th>
                </tr>
            </thead>
            <tbody>
                <tr>
                    <td colspan="3" width="25%"><img src="images/BCP.png"></td>
                    <td  width="2%">:</td>
                    <td>
                    <p>
                        <b>
                    BANCO          : BCP<br/>
                    Nro Cuenta     : 304528-25415-26545<br>
                    Beneficiario   : Victor Jose Carreño Guerra.<br>
                    <br>
                    </p></b>
                    </td>
             ...
             <tr>
                    <td colspan="3" width="25%"><img src="images/bn.png"></td>
                    <td  width="2%">:</td>
                    <td>
                    <p>
                        <b>
