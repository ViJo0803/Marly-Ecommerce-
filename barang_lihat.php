				...
				<form class="form-horizontal qtyFrm">
				  <div class="control-group">
					...
					<!--<input type="number" class="span1" placeholder="Qty."/>--->
					  <a href="?open=Barang-Beli&Kode=<?php echo $KodeBarang; ?>&stok=<?php echo $stok; ?>" class="btn btn-link"><i class=" icon-shopping-cart"></i> Comprar</a>
					</div>
				  </div>
				</form>
...
<!-- Aqui Termina Bucle Pruductos relacionados-->			
					...
					<div class="thumbnail">
						...
						<div class="caption">
						  ...
						  <h4><a class="btn btn-link" href="?open=Barang-Lihat&Kode=<?php echo $codigo; ?>">VER</a> <span class="pull-right">S/.<?php echo format_angka($precio); ?></span></h4>
						</div>
					  </div>
					</li>
					<!--<li class="span3">
