            ...
            <tr>
                ...
                <td><div class="controls">
                    <select type="text" id="methodpayment" name="cmbPayment">
                        ...
                        <option>Deposito a cuenta Banco</option>
...
<br><br>
        ...
        <tbody>
          ...
          <tr>
            ...
            <td width="94%" colspan="2">El pago puede hacerse a través de transferencias de dinero entre bancos. Usted puede transferir dinero de su banco y también a través de cajeros automáticos. Aceptamos transferencias de dinero a través de cuentas bancarias BCP y Banco de la Nacion.</td>
          </tr>
          <tr>
          ...
          <tr>
            ...
            <td colspan="2">También aceptamos pagos contra entrega solo en la ciudad de Huaraz.</td>
          </tr>
          <tr>
              <td>&nbsp;</td>
          ...
          <tr>
              <td>&nbsp;</td>
              <td align="center" valign="top">*</td>
              <td colspan="2">•	El límite máximo de pago es de 2 dias desde el momento de la reserva, a través de los métodos de pago anteriores.</td>
          </tr>
         <tr>
              <td>&nbsp;</td>
              <td>*</td>
